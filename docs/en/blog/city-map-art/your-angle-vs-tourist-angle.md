---
title: "Your Angle vs. The Tourist's Angle: Why Generic Map Art Misses the Point"
description: >
  Every art store sells the same north-up tourist grid of the same five cities.
  MapVibe is different — your city, at your angle, centred on what matters to you.
  Here's why that distinction matters.
slug: /blog/city-map-art/your-angle-vs-tourist-angle/
keywords:
  - custom map art vs generic
  - personalized city map
  - non-standard map bearing
  - expat custom map print
  - city map art unique perspective
  - my city map custom angle
schema:
  - Article
  - HowTo
pillar: Perspective Shift + Bearing = Personality
ui_assets_needed:
...
::: tabs
**Tourist's angle**
- Centre: Famous landmark (Empire State, Christ the Redeemer, Eiffel Tower)
- Bearing: 0° north-up
- Zoom: Whole city / skyline
- Theme: One of three safe palettes
- Meaning: Generic art. Could be anyone's.
---
**Your angle**
- Centre: Your neighbourhood, your block, your street
- Bearing: The direction that matches how you walked it
- Zoom: The streets you actually remember
- Theme: The one that matches your memory of the light, the mood, the feeling
- Meaning: Yours. Only yours.
:::

---

![MapVibe bearing control UI — rotate your map to any angle](/assets/images/bearing-control-ui.png)

![São Paulo bearing rotation — animated](/assets/images/bearing-grid-sao-paulo.gif)
...
![São Paulo 4-bearing comparison grid — how rotation changes everything](/assets/images/bearing-grid-sao-paulo.png)
...
::: hero
[Make Your Map →](https://app.mapvibestudio.com)
:::
