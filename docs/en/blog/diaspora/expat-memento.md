---
title: "When You Move Abroad, You Start Seeing Home Differently"
description: >
  Living abroad changes how you think about where you come from. Expats and
  diaspora communities share one thing: home gets sharper the further away you are.
  A custom map of your neighbourhood is the memento that holds that feeling.
slug: /blog/diaspora/expat-memento/
keywords:
  - expat memento map
  - diaspora custom map print
  - personalized map for expats
  - custom neighbourhood map poster
  - city map print for expats abroad
  - map of my hometown personalized
schema:
  - Article
  - FAQPage
  - HowTo
